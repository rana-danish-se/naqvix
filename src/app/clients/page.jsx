  ...
  return (
    <div className={`transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
      <GlassmorphismCard className="text-center">
        ...
        <div className="text-gray-700 dark:text-gray-300 font-medium">{label}</div>
      </GlassmorphismCard>
    </div>
  );
};
...
export default function OurClientsPage() {
  ...
  const testimonials = [
    {
      quote: "Naqvix transformed our business processes with their innovative AI solutions. The efficiency gains have been remarkable.",
      author: "Sarah Johnson",
      company: "ROADSIDER",
      rating: 5
    },
    {
      quote: "Their BPO services are exceptional. Professional, reliable, and they truly understand our business needs.",
      author: "Ahmed Hassan",
      company: "REHAISH",
      rating: 5
    },
    {
      quote: "The IT consulting provided by Naqvix helped us modernize our entire infrastructure. Highly recommended!",
  ...
  return (
    <div className={`min-h-screen transition-colors duration-500 ${isDark ? 'dark bg-black' : 'bg-white'}`}>
          ...
          <div className="max-w-3xl mx-auto mb-16">
            <GlassmorphismCard>
              ...
              <p className="text-lg text-gray-800/90 dark:text-white/90 leading-relaxed">
                We've partnered with industry leaders across the globe to deliver cutting-edge technology solutions, 
                AI implementations, and business process optimizations that drive real results.
              </p>
            </GlassmorphismCard>
          </div>
        </div>
      ...
      <section className="w-full py-16 px-8">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
            <StatCard icon={Users} number={150} label="Happy Clients" delay={0} />
            <StatCard icon={TrendingUp} number={250} label="Projects Completed" delay={1} />
            <StatCard icon={Award} number={98} label="Success Rate %" delay={2} />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
            {clients.map((client, index) => (
              <ClientLogo key={client.alt} src={client.src} alt={client.alt} delay={index} />
            ))}
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <GlassmorphismCard>
              ...
              <p className="text-gray-800/90 dark:text-white/90 mb-6">
                Helped a leading logistics company reduce processing time by 70% through custom AI solutions 
                and automated workflows, resulting in $2M+ annual savings.
              </p>
              <div className="flex items-center gap-4 text-sm text-gray-600 dark:text-gray-400">
                <span className="bg-blue-100 dark:bg-blue-900 px-3 py-1 rounded-full">AI Solutions</span>
                <span className="bg-purple-100 dark:bg-purple-900 px-3 py-1 rounded-full">Process Optimization</span>
              </div>
            </GlassmorphismCard>
            ...
            <GlassmorphismCard>
              ...
              <p className="text-gray-800/90 dark:text-white/90 mb-6">
                Modernized IT infrastructure for a manufacturing giant, implementing cloud solutions 
                and business intelligence tools that improved operational efficiency by 45%.
              </p>
              <div className="flex items-center gap-4 text-sm text-gray-600 dark:text-gray-400">
                <span className="bg-green-100 dark:bg-green-900 px-3 py-1 rounded-full">Cloud Migration</span>
                <span className="bg-orange-100 dark:bg-orange-900 px-3 py-1 rounded-full">IT Consulting</span>
              </div>
            </GlassmorphismCard>
          </div>
        </div>
