...
export default function Blogs() {
  ...
  return (
    <main className="flex flex-col items-center justify-center p-4 w-full gap-5 my-5">
      {/* Header Section */}
      <div className="flex flex-col items-center justify-center gap-5">
        <h1
          className="text-[6vw] w-[90%] text-center lg:text-left md:text-[4.25vw] font-extrabold leading-tight 
        ...
        <p
          className="w-full text-center m-auto lg:m-0 md:w-3/4 text-base md:text-lg
