      ...
      <section className="w-full pt-20 pb-16 flex items-center justify-center gap-10 px-8">
        ...
        <div className="flex flex-col gap-5 w-[50%]">
          ...
          <GlassmorphismCard className="w-full">
            ...
            cutting-edge solutions while maintaining operational excellence. Our
            journey began with a simple belief: every business deserves access
            to world-class IT, AI, and business process solutions that drive
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <GlassmorphismCard className="w-full h-full">
                ...
                recognized for our innovation, integrity, and impact. We
                envision a future where every business can harness the power of
                technology to create meaningful value for their stakeholders and
                communities.
              </GlassmorphismCard>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {coreValues.map((value, index) => (
              <GlassmorphismCard key={index} className="text-center h-full">
                <h3 className="text-xl font-bold bg-gradient-to-r from-blue-500 via-purple-500 to-purple-700 bg-clip-text text-transparent dark:bg-gradient-to-r dark:from-white dark:via-zinc-200 dark:to-zinc-400 mb-4">
                  {value.title}
                </h3>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {achievements.map((achievement, index) => (
              <GlassmorphismCard key={index} className="text-center">
                <h3 className="text-4xl font-bold bg-gradient-to-r from-blue-500 via-purple-500 to-purple-700 bg-clip-text text-transparent dark:bg-gradient-to-r dark:from-white dark:via-zinc-200 dark:to-zinc-400 mb-2">
                  {achievement.number}
                </h3>
          ...
          <GlassmorphismCard className="w-full">
            <div className="text-center">
              <h3 className="text-2xl font-bold bg-gradient-to-r from-blue-500 via-purple-500 to-purple-700 bg-clip-text text-transparent dark:bg-gradient-to-r dark:from-white dark:via-zinc-200 dark:to-zinc-400 mb-6">
                Key Milestones
              </h3>
